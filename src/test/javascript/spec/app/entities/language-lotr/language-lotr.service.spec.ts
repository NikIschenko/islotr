...
describe('Service Tests', () => {
  describe('LanguageLotr Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a LanguageLotr', async () => {
      ...
      it('should update a LanguageLotr', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB'
          },
      ...
      it('should return a list of LanguageLotr', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB'
          },
      ...
      it('should delete a LanguageLotr', async () => {
