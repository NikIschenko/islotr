...
import by.issoft.config.audit.AuditEventConverter;
import by.issoft.domain.PersistentAuditEvent;
...
import static by.issoft.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
